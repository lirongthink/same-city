...
class BuyOrderDetial extends StatefulWidget {
  BuyOrderDetial({Key key, this.orderId}) : super(key: key);

  final String orderId;

  @override
  _BuyOrderDetialState createState() => _BuyOrderDetialState(orderId);
}

class _BuyOrderDetialState extends State<BuyOrderDetial> {
  
  _BuyOrderDetialState(this.orderId);
  final String orderId;
