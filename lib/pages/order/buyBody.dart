...
class OrderListBuyBody extends StatefulWidget {
  OrderListBuyBody({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _OrderListBuyBodyState();
}

class _OrderListBuyBodyState extends State<OrderListBuyBody> with AutomaticKeepAliveClientMixin {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context,index){
                  return Container(
                    ...
                    child: Card(
                      child: OrderItem(model:data[index]),
                    ),
                  );
                } 
  ...
  Future<void> fetchMoreData() async {
    if (loadingState != LoadingState.loading) { 
      ...
      var res = await https('get','order/getBuyOrder',obj);
