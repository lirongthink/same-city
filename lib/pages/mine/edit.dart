...
class _EditInfoState extends State<EditInfo> {
  ...
  void initForm() async{
    ...
    print(userRes.data);
    if (userRes.data['data']['nickname'] != null && userRes.data['data']['name'] != null && userRes.data['data']['phone'] != null && userRes.data['data']['address'] != null) {
  ...
  void EditInfoForm() {
    ...
    var flag = EditInfoFormKey.currentState.validate();
if (flag) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            Form(
              key: EditInfoFormKey, //设置globalKey，用于后面获取FormState
              autovalidate: true,
              child: Column(
                children: <Widget>[
                  TextFormField(
